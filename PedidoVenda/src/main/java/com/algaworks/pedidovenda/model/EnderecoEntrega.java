...
public class EnderecoEntrega implements Serializable {
    ...
    private static final long serialVersionUID = 6504839855336152492L;
    ...
    public EnderecoEntrega(String logradouro, String numero, String complemento, String cidade, String uf, String cep) {
	super();
	...
	return "EnderecoEntrega [logradouro=" + logradouro + ", numero=" + numero + ", complemento=" + complemento + ", cidade=" + cidade
		+ ", uf=" + uf + ", cep=" + cep + "]";
    }
